...
Route::match(['get', 'post'], '/wallet/check-defaulter', [WalletController::class, 'checkDefaulters']);
Route::match(['get', 'post'], '/wallet/defaulters', [WalletController::class, 'defaulterReport']);
